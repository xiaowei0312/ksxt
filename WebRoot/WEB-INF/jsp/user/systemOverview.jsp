		...
		<div class="state-info">
			...
			<section class="panel">
				<div class="panel-body">
					...
					<div id="expense1" class="chart-bar"></div>
				</div>
			</section>
		</div>
	</div>
							...
							<div class="col-sm-6 col-xs-6">
								<div class="knob">
									<span class="chart" data-percent="56"> <span
										class="percent">56% <span class="sm">Bounce rate</span></span>
									</span>
								</div>
							</div>
						</div>
