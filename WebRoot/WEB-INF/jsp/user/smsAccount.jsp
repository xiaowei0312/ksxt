...
<body class="sticky-header">
								...
								<ul class="goal-progress">
									<li>
										<div class="prog-avatar">
											<img
												src="${pageContext.request.contextPath}/images/photos/user1.png"
												alt="" />
										</div>
										<div class="details">
											<div class="title">
									...
									<li>
										<div class="prog-avatar">
											<img
												src="${pageContext.request.contextPath}/images/photos/user2.png"
												alt="" />
										</div>
										<div class="details">
											<div class="title">
									...
									<li>
										<div class="prog-avatar">
											<img
												src="${pageContext.request.contextPath}/images/photos/user3.png"
												alt="" />
										</div>
										<div class="details">
											<div class="title">
									...
									<li>
										<div class="prog-avatar">
											<img
												src="${pageContext.request.contextPath}/images/photos/user5.png"
												alt="" />
										</div>
										<div class="details">
											<div class="title">
	...
	<!--easy pie chart-->
	<script
		src="${pageContext.request.contextPath}/js/easypiechart/jquery.easypiechart.js"></script>
	<script
		src="${pageContext.request.contextPath}/js/easypiechart/easypiechart-init.js"></script>

	<!--Sparkline Chart-->
	<script
		src="${pageContext.request.contextPath}/js/sparkline/jquery.sparkline.js"></script>
	<script
		src="${pageContext.request.contextPath}/js/sparkline/sparkline-init.js"></script>

	<!--icheck -->
	<script
		src="${pageContext.request.contextPath}/js/iCheck/jquery.icheck.js"></script>
	<script src="${pageContext.request.contextPath}/js/icheck-init.js"></script>

	<!-- jQuery Flot Chart-->
	<script
		src="${pageContext.request.contextPath}/js/flot-chart/jquery.flot.js"></script>
	<script
		src="${pageContext.request.contextPath}/js/flot-chart/jquery.flot.tooltip.js"></script>
	<script
		src="${pageContext.request.contextPath}/js/flot-chart/jquery.flot.resize.js"></script>


	<!--Morris Chart-->
	<script
		src="${pageContext.request.contextPath}/js/morris-chart/morris.js"></script>
	<script
		src="${pageContext.request.contextPath}/js/morris-chart/raphael-min.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/js/calendar/moment-2.2.1.js"></script>
 ...
 -->
	...
	<!--Dashboard Charts-->
	<script
		src="${pageContext.request.contextPath}/js/dashboard-chart-init.js"></script>
	<!--body wrapper end-->
</body>