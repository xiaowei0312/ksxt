...
<body class="sticky-header">
									...
									<div class="col-md-5" style="padding-left: 0">
										...
										<div class="col-md-3">
											<select class="form-control" name="typeSelect" id="typeSelect">
												<option value="-2" checked="checked">All Dir</option>
											</select>
										</div>
										<div class="col-md-3">
											<select class="form-control" name="timeOrderBy"
												id="timeOrderBy">
												<option value="0" checked="checked">开班时间降序</option>
												<option value="1">开班时间升序</option>
											</select>
										</div>
										<div class="col-md-3">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<section class="panel">
												<header class="panel-heading"> 修改班级信息 </header>
												<div class="panel-body">
													<form class="form-horizontal" role="form"
														id="editModalForm">
														<div class="form-group">
															<label for="commodityName_editModal"
																class="col-lg-2 col-sm-2 control-label">班级名称</label>
															<div class="col-lg-10">
														...
														<div class="form-group">
															<label for="commodityType_editModal"
																class="col-lg-2 col-sm-2 control-label">实训方向</label>
															<div class="col-lg-10">
																<select name="dirId" id="commodityType_editModal">
																	<option value="-2">--- 选择实训方向 --</option>
																</select>
													...
													<form class="form-horizontal" role="form" id="addModalForm">
														...
														<div class="form-group">
															<label for="commodityType_addModal"
																class="col-lg-2 col-sm-2 control-label">实训方向</label>
															<div class="col-lg-10">
																<select name="dirId" id="commodityType_addModal">
																	<option value="-2">--- 选择实训方向 --</option>
																</select>
																<!-- <p class="help-block">Please select the question type.</p> -->
															</div>
	...
	<script src="js/trainingClassList.js"></script>
	<script type="text/javascript">
