...
<body class="sticky-header">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<section class="panel">
												<header class="panel-heading"> 修改实训方向信息 </header>
												<div class="panel-body">
													<form class="form-horizontal" role="form" id="editModalForm">
														<div class="form-group">
															<label for="typeName"
																class="col-lg-2 col-sm-2 control-label">实训方向名称</label>
															<div class="col-lg-10">
																<input type="hidden" class="form-control"
																	id="typeId" name="id">
																<input type="text" class="form-control" name="name"
																	id="typeName" placeholder="类别名称">
																<p class="help-block">名称会显示在前台网站上.</p>
															</div>
														</div>
														<div class="form-group">
															<label for="typeSeq"
							...
							<div aria-hidden="true" aria-labelledby="myModalLabel"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											<section class="panel">
												<header class="panel-heading"> 添加实训方向 </header>
												<div class="panel-body">
	...
	<script src="js/trainingDirList.js"></script>
	<script type="text/javascript">
